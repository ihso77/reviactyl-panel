...
use App\Database\Schema\Grammars\CustomSQLiteGrammar;
use App\Models;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // SQLite: Use custom grammar that handles DROP INDEX IF EXISTS
        if (DB::connection()->getDriverName() === 'sqlite') {
            DB::connection()->setSchemaGrammar(new CustomSQLiteGrammar(DB::connection()));
        }
